                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                        ...
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group mr-2">
                                <a href="{{ route('service.admin') }}"><button type="button"
                                        class="btn btn-sm btn-outline-secondary dropdown-toggle">
                                        <span data-feather="calendar"></span>
                                        {{ __('Cписок') }}
                                    </button></a>
                                <a href="{{ route('service.create') }}"><button type="button"
                                        class="btn btn-sm btn-outline-secondary">{{ __('Добавить услугу') }}
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width: 160px">
                                                <div class="btn-group-inline">
                                                    ...
                                                    @if ($newsItem->active === 0)
                                                        <form class="pb-2" action="{{ route('service.updateActive', $newsItem->id) }}"
                                                              method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                    ...
                                                    <form action="{{ route('service.show', $newsItem->id) }}" method="get">
                                                        <button type="submit" class="btn btn-sm btn-outline-secondary">
                                                            {{ __('Смотреть') }}
                                                    ...
                                                    <form class="py-2" action="{{ route('service.edit', $newsItem->id) }}" method="get">
                                                        <button type="submit" class="btn btn-sm btn-outline-secondary">
                                                            {{ __('Редактировать') }}
                                                    ...
                                                    <form action="{{ route('service.destroy', $newsItem->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
