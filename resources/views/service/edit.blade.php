...
@section('content')
    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('service.admin') }}">{{ __('Услуги') }}</a></li>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mx-auto">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <h1 class="h2">{{ __('Редактировать услугу') }}</h1>
                ...
                <form action="{{ route('service.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group py-2">
                        ...
                        <textarea style="margin: 0" class="form-control height150" name="intro" required>{{ $news->intro }}</textarea>
                    </div>

                    <div class="form-group py-2">
                        <label>Описание</label>
                        <textarea style="margin: 0" class="form-control height150" name="info" required>{{ $news->info }}</textarea>
                    </div>
