                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                        ...
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group mr-2">
                                <a href="{{ route('partner.admin') }}"><button type="button"
                                        class="btn btn-sm btn-outline-secondary dropdown-toggle">
                                        <span data-feather="calendar"></span>
                                        {{ __('Cписок') }}
                                    </button></a>
                                <a href="{{ route('partner.create') }}"><button type="button"
                                        class="btn btn-sm btn-outline-secondary">{{ __('Добавить партнера') }}
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width: 160px">
                                                <div class="btn-group-line">
                                                    ...
                                                    @if ($newsItem->active === 0)
                                                        <form class="pb-2" action="{{ route('partner.updateActive', $newsItem->id) }}"
                                                              method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                    ...
                                                    <form action="{{ route('partner.edit', $newsItem->id) }}" method="get">
                                                        <button type="submit" class="btn btn-sm btn-outline-secondary">
                                                            {{ __('Редактировать') }}
                                                    ...
                                                    <form class="py-2" action="{{ route('partner.destroy', $newsItem->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
